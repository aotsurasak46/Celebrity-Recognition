...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(f'result/acc_graph/80acc_mobilenetV2_bs{batch_size}_e{epochs}_grey_lr{learningrate}_nn{num_nodes}_c{num_classes}_fr{isFreeze}.png')  # Save the accuracy plot as an image
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(f'result/loss_graph/80loss_mobilenetV2_bs{batch_size}_e{epochs}_grey_lr{learningrate}_nn{num_nodes}_c{num_classes}_fr{isFreeze}.png')  
...
model.save(f'result/model/80mobilenetV2_bs{batch_size}_e{epochs}_grey_lr{learningrate}_nn{num_nodes}_c{num_classes}_fr{isFreeze}.h5')